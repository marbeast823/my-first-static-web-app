...
if($error==1) {
echo "<table width=650 CELLSPACING=0 BORDER=0 CELLPADDING=0 align=center>";
$perRow=2;
$r=0;
$resTop1 = mssql_query("SELECT ProductNum, ItemMain, ItemSub, Duration, ItemStock, ItemMoney, ItemImage,ItemName,ItemComment FROM RanShop.dbo.ShopItemMap where Category = '400'");
while($result1 = mssql_fetch_array( $resTop1)) {
		$r++;	
			...
			$Description1 = $result1["ItemComment"]; 
			    ...
			    echo "
<td><td><div align='center'><a href='items/$result1[ItemImage]' rel='lightbox' title='Click Here For Zoom In'><img src='items/$result1[ItemImage]' alt='$result1[ItemImage]' width='80' height='80' style='border:none;'></a></div></td>
            <td width='200' class=alt1 align='left'><br><font color='gray' size=2><b>$result1[ItemName]</b>
<br><font face=arial size=2>Price : <font face='trebuchet ms' size=2 color=red> $result1[ItemMoney] Points</b></font><br><form name='buy' action='webshop.php?op=confirm' method='post' autocomplete='off'>
				...
				<input type=submit name=submit value=' Detail & Buy 'name='submit' value='Submit' tabindex='5' class='btn2' style='font-size:11px;height:24px;width:90px;' />
			</form><br></td></td><td></div><td>";						
...
?>
<br><center><a href="/webshop.php?op=scroll=5"> [Back Page] </a>|<a href="/webshop.php?op=scroll=1"> [First Page]</a> <a href="/webshop.php?op=scroll=1"> 1 </a>  <a href="/webshop.php?op=scroll=2"> 2 </a><a href="/webshop.php?op=scroll=3"> 3 </a> </a><a href="/webshop.php?op=scroll=4"> 4 </a><a href="/webshop.php?op=scroll=5">5 </a>6Page 