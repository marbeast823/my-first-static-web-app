...
$perRow=2;
$r=0;
$resTop1 = mssql_query("SELECT ProductNum, ItemMain, ItemSub, Duration, ItemStock, ItemMoney, ItemImage,ItemName,ItemComment FROM RanShop.dbo.ShopItemMap where Category = '9'");
...
?>
<br><center><a href="/webshop.php?op=weapon=3"> [Back Page] </a>|<a href="/webshop.php?op=weapon=5"> [Next Page]</a> <a href="/webshop.php?op=weapon=1"> 1 </a>  <a href="/webshop.php?op=weapon=2"> 2 </a><a href="/webshop.php?op=weapon=3"> 3 </a> 4 Page <a href="/webshop.php?op=weapon=5"> 5 </a><a href="/webshop.php?op=weapon=6"> 6 </a> 