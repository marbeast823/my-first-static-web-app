...
$perRow=2;
$r=0;
$resTop1 = mssql_query("SELECT ProductNum, ItemMain, ItemSub, Duration, ItemStock, ItemMoney, ItemImage,ItemName,ItemComment FROM RanShop.dbo.ShopItemMap where Category = '10'");
...
?>
<br><center><a href="/webshop.php?op=weapon=4"> [Back Page] </a>|<a href="/webshop.php?op=weapon=6"> [Next Page]</a> <a href="/webshop.php?op=weapon=1"> 1 </a>  <a href="/webshop.php?op=weapon=2"> 2 </a><a href="/webshop.php?op=weapon=3"> 3 </a> </a><a href="/webshop.php?op=weapon=4"> 4 </a>5 Page<a href="/webshop.php?op=weapon=6"> 6 </a> 