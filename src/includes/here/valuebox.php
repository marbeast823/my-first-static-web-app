...
if($error==1) {
echo "<table width=800 CELLSPACING=2 BORDER=1 CELLPADDING=2 align=center>";
$perRow=3;
$r=0;
$resTop1 = mssql_query("SELECT ProductNum, ItemMain, ItemSub, Duration, ItemStock, ItemMoney, ItemImage,ItemName,ItemComment FROM RanShop.dbo.ShopItemMap where Category = '3'");
