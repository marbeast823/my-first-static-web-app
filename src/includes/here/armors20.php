...
<br>Duration: $Duration1<br>Description: $result1[ItemComment]<br><br>Stock: <b>$result1[ItemStock]</b><br>Price: <b>$result1[ItemMoney]</b></font><br><form name='buy' action='itemshop.php?op=show2' method='post' autocomplete='off'>
