...
<?php
	...
	*/
	...
	$targetpage = "itemshop.php?op=All"; 	//your file name  (the name of this file)
...
$perRow=2;
$r=0;
$resTop1 = sqlsrv_query($connect_mssql,"SELECT ProductNum, ItemMain, ItemSub, Duration, ItemStock, ItemMoney, ItemImage,ItemName,ItemComment FROM RanShop.dbo.ShopItemMap where Category = '4'");
