...
{
$url ="http://www.mmorpgtop200.com/in.php?site=";
}
if($op=="votenow")
{
$tm = time();
...
echo "<div align=center><script language='javascript'text/javascript'>alert('Please Vote Only Every 12 - Hours')</script></div><p>";
quickrefresh('boto.php');
}
}else{

echo "<table 'width='650' cellspacing='0' cellpadding='0' align='center' rules='cols' bordercolor='#C1C1C1' border='1' id='ctl00_ContentPlaceHolder_main_rank_GridView1' bgcolor='White''>
              <tr>
                <td valign='top' width='120'><table>
                    <tr>
                      <td style='border-bottom:none;'><img id='ctl00_ContentPlaceHolder_main_MartList_ctl00_wupinpic' class='bbb' src='items/$ItemImage1' rel='facebox' style='height:80px;width:80px;border-width:0px;' />
                      
                      </td>
                    </tr>
                    <tr></td><br><center>Every vote will reward you 2 points, after 24 hour's you can vote again.<br><br><br><br><table align='center'>


<form action=\"boto.php?op=votenow\" method=\"post\">";
echo "<input type=\"hidden\" name=\"vid\" value=\"1\"/>";
echo "<center><input type=\"image\" name=\"submit\" src=\"http://www.xtremeTop100.com/votenew.jpg\" name=\"send\" Value=\"Vote Now!\"/></form>";
///next
echo "<form action=\"boto.php?op=votenow\" method=\"post\">";
echo "<input type=\"hidden\" name=\"vid\" value=\"2\"/>";
echo "<center><input type=\"image\" name=\"submit\" src=\"http://www.gtop100.com/images/votebutton.jpg\" name=\"send\" Value=\"Vote Now!\"/></form>";
///next
echo "<form action=\"boto.php?op=votenow\" method=\"post\">";
echo "<input type=\"hidden\" name=\"vid\" value=\"3\"/>";
echo "<center><input type=\"image\" name=\"submit\" src=\"http://www.jagtoplist.com/images/vbtn88x55.jpg\" name=\"send\" Value=\"Vote Now!\"/></form>";
///next
echo "<form action=\"boto.php?op=votenow\" method=\"post\">";
echo "<input type=\"hidden\" name=\"vid\" value=\"4\"/>";
echo "<center><input type=\"image\" name=\"submit\" src=\"http://www.gamesites100.net/images/nvotebutton.jpg\" name=\"send\" Value=\"Vote Now!\"/></form>";
///next
echo "<form action=\"boto.php?op=votenow\" method=\"post\">";
echo "<input type=\"hidden\" name=\"vid\" value=\"5\"/>";
echo "<center><input type=\"image\" name=\"submit\" src=\"http://www.mmorpgtop200.com/votenew.jpg\" name=\"send\" Value=\"Vote Now!\"/></form>
</center></table> <br><br><br><br><center>Please be honest and give extra effort to vote. So the server can stay UP and Online! <br><br>";
}
