...
echo "
 ...
 ";
$i=0;
$resTop = mssql_query("SELECT TOP 10 P.ChaName, P.ChaLevel, P.ChaClass, P.ChaSchool, P.ChaKill, P.GuNum, P.ChaNum FROM RanGame1.dbo.ChaInfo P, RanUser.dbo.UserInfo U WHERE P.UserNum = U.UserNum AND U.UserType != 30 AND P.ChaDeleted != 1 ORDER BY P.ChaKill DESC, P.ChaLevel DESC");
...
echo"
							...
							<td width='138' style='border-bottom:#CCCCCC 1px solid' align='center'>$Name</td>
                            				...
                            				<td width='95' align='center' style='border-bottom:#CCCCCC 1px solid'>$Kill</td>
