...
$secu = stripslashes((int)$_POST['secu']);
if(valid($accountid))
{
...
if(strlen($passwordid)>13)
{
                       echo('<script language="Javascript">alert("[Password]Please Provide Only 13 Characters to Login"); </script>');
...
if ($accountid == null) {
                       echo('<script language="Javascript">alert("Please Type your Username/Password"); window.location = "ilogin.php"; </script>');}

if ($secu!=$scode) {
		{

	quickrefresh('login.php'); 

Die ('<script language="JavaScript">
		alert("Security Code is Incorrect. Please Retype Again.");
		</script>'); }
		$error = 1;
	}
		...
		if ($login_result === false) {
                       echo('<script language="Javascript">alert("UserName and Password is not Match. Please Try Again."); window.location = "login.php"; </script>');}

                    if ($login_result === true) 
                          {
                       echo('<script language="Javascript">alert("Welcome '.$accountid.', Vote To Get RE-Points."); window.location = "login.php"; </script>');
