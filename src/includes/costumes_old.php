...
<?php
	...
	*/
	...
	$targetpage = "itemshop.php?op=costumes"; 	//your file name  (the name of this file)
...
$perRow=2;
$r=0;
$resTop1 = mssql_query("SELECT ProductNum, ItemMain, ItemSub, Duration, ItemStock, ItemMoney, ItemImage,ItemName,ItemComment FROM RanShop.dbo.ShopItemMap where Category = '7'");
