...
<head>
	<title><?php require("config.php"); echo($web['webtitle']); ?> - <?php if(!isset($_GET['op'])){echo("");} else{echo(ucfirst($_GET['op']));} ?> Hybrid All Player Rankings</title>
...
<body>
	...
	<div class="page">
		...
		<div class="contside">
			<ul class="lnb_menu">
				<li><div class="icons ico_lnb"></div><a href="rank.php" title="Hot Items" class="selected">All Players hybrid</a></li>
...
<div style="padding:10px 0;"><center><a href="http://ranindonesia.com/c3-premium-items"><img src="images/premium_title.png" /></a></center></div>
                  ...
                  <table><? include_once("modules/rank.php"); ?></table>
</div>
