...
class sql_inject
{
	 ...
	 * @type void
     */
    function sql_inject($mLog=FALSE,$bdestroy_session=TRUE,$urlRedirect=TRUE)
    {
        $this->bLog = (($mLog!=FALSE)?$mLog:'');
        $this->urlRedirect = (((trim($urlRedirect)!='http://google.com') && file_exists($urlRedirect))?$urlRedirect:'http://google.com');
