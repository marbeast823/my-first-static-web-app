...
$i=0;
$resTop = mssql_query("SELECT TOP 50 P.ChaName, P.ChaLevel, P.ContributionPoint, P.ChaClass, P.ChaSchool, P.ChaOnline, P.GuNum, P.ChaNum FROM RanGameS1.dbo.ChaInfo P, RanUser.dbo.GSUserInfo U WHERE P.UserNum = U.UserNum AND U.UserType != 30 AND U.UserAvailable != 0 AND P.ChaDeleted != 1 AND  P.chaSchool != 0 AND P.chaSchool != 2 AND P.SGNUM != 1 ORDER BY  P.ChaReborn DESC, P.ChaLevel DESC");
