...
$i=0;
$resTop = mssql_query("SELECT TOP 100 P.ChaName, P.ChaLevel, P.ContributionPoint, P.ChaClass, P.ChaSchool, P.ChaOnline, P.GuNum, P.ChaNum FROM RanGameS1.dbo.ChaInfo P, RanUser.dbo.GSUserInfo U WHERE P.UserNum = U.UserNum AND U.UserType != 30 AND P.ChaDeleted != 1 AND P.chaSchool != 1 AND P.chaSchool != 0 AND P.chaSchool != 0 ORDER BY P.ChaReborn DESC, P.ChaLevel DESC");
