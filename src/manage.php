...
<head>
	<title><?php require("config.php"); echo($web['webtitle']); ?> - <?php if(!isset($_GET['op'])){echo("");} else{echo(ucfirst($_GET['op']));} ?> Manage Account</title>
		...
		<div class="main">
			...
			<div class="container">
				<div class="left_wrap">
							...
							<div class="signup"><a href="recharge.php"><img src="images/recharge_on.gif"></a></div>				
					</div>
			...
			<div class="contside">
			<ul class="lnb_menu">
			<br><li><a href="register.php" target="_top"><img src="images/tankace/common/signup_btn.gif" alt="Sign Up" /></a></li>
				<li><div class="icons ico_lnb"></div><a href="manage.php?op=user&option=accountinfo" title="Hot Items" class="selected">User Account Information</a></li>
				<li><div class="icons ico_lnb"></div><a href="manage.php?op=user&option=changepassword" title="Hot Items" class="selected">Change User Password</a></li>
				<li><div class="icons ico_lnb"></div><a href="manage.php?op=user&option=characters" title="Hot Items" class="selected">Character Information</a></li>
				</ul>
			</div>
			...
			<div class="contside">
				<ul class="lnb_menu">
				<li><div class="icons ico_lnb"></div><a href="" title="FAQ" class="selected">Frequent Ask</a></li>
